...
{
    return [self successNoticeInView:view title:title dismiss:nil];
}
+ (WBSuccessNoticeView *)successNoticeInView:(UIView *)view title:(NSString *)title dismiss:(void (^)(BOOL dismissedInteractively))block{
